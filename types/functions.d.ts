...
*/
export function render(html: string, options?: RenderOptions): Promise<RenderOutput>;
 ...
 */
export function safeClassNames(html: string, replacements: Record<string, string>): string;
 ...
 */
export function markdown(input: string, options?: MarkdownItOptions): string;
...
*/
export function preventWidows(html: string, options?: WidowWordsConfig): string;
...
*/
export function attributeToStyle(
  html: string,
...
*/
export function inlineCSS(html: string, options?: InlineCSSConfig): string;
...
@param {string} html The HTML string to render.
*/
export function shorthandCSS(html: string): string;
...
*/
export function removeUnusedCSS(html: string, options?: RemoveUnusedCSSConfig): string;
...
*/
export function addAttributes(html: string, options?: Record<string, unknown>): string;
...
*/
export function prettify(html: string, options?: CoreBeautifyOptions): string;
...
*/
export function applyBaseURL(html: string, options?: string | BaseURLConfig): string;
...
*/
export function addURLParameters(html: string, options?: URLParametersConfig): string;
...
@param {string} html The HTML string to use.
*/
export function ensureSixHex(html: string): string;
...
*/
export function minify(html: string, options?: MinifyConfig): string;
...
*/
export function replaceStrings(html: string, replacements?: Record<string, string>): string;
...
*/
export function plaintext(html: string, options?: PlaintextConfig): Promise<{
  html: string;
  plaintext: string;
  destination: string;
}>;
